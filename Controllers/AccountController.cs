    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var result = await _signInManager.PasswordSignInAsync(model.PhoneNumber.ToString(), model.Password, model.RememberMe, lockoutOnFailure: false);
                if (result.Succeeded)
                {
        ...
        [Authorize(Roles = "Aggregator, Super Admin")]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> RegisterFarmer(RegisterFarmerViewModel model, string returnUrl = null)
        {
            //fetching user here in order to fetch user id
            //var user1 = await _userManager.GetUserAsync(User);
            ViewData["ReturnUrl"] = returnUrl;
            try
            {
        ...
        public IActionResult RegisterUser(string User,string AddedByAgg,string error = null, string returnUrl = null)
        {
            ...
            ViewBag.CreateUser = User;
            ViewBag.AddedByAgg = AddedByAgg;
            return View();
        }
        ...
        [Authorize(Roles = "Super Admin,Admin,Aggregator")]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> RegisterUser(RegisterViewModel model, string AddedByAgg, string returnUrl = null)
        { 
            ViewData["ReturnUrl"] = returnUrl;
            try
            {
                ...
                //{
                    var user = new ApplicationUser
                    {
                        FirstName = model.FirstName,
                        LastName = model.LastName,
                        NationalIDNumber = model.NationalId,
                        Gender = model.Gender,
                        ...
                        AggregatorRepresentativePhoneNumber = model.AggregatorRepresentativePhoneNumber,
                        supplierRepresentativePhoneNumber = model.supplierRepresentativePhoneNumber,
                        //  Dob = model.Dob,   
                        //  KraPin = model.KraPin,
                        PhoneNumber = model.MobileNumber,
                        Email = model.Email,
        ...
        public IActionResult Register(string User, string returnUrl = null)
        {
            ViewData["ReturnUrl"] = returnUrl;
            ViewBag.CreateUser = User;
            return View();
